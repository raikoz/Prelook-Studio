...
import { User, HistorySession, Booking, PaymentItem } from '../types';
...
export const UserDashboard: React.FC<UserDashboardProps> = ({ user, onClose, onTopUp }) => {
            ...
            <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-1 space-y-6">
                    <div className="bg-white p-6 rounded-3xl border border-brand-100 shadow-sm">
                        ...
                        <button 
                            onClick={() => onTopUp({ type: 'CREDITS', name: '50 Credits Pack', price: 199, creditsValue: 50 })}
                            className="w-full py-3 bg-brand-900 text-white rounded-xl text-xs font-bold uppercase tracking-widest hover:bg-black transition-colors"
                        >
                            Top Up Credits
                        </button>
                    </div>
