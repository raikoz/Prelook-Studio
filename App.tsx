...
import { AppView, GenerationState, HistorySession, User, GeneratedImages, SubscriptionTier, GenerationConfig, PaymentItem } from './types';
...
export default function App() {
  ...
  const handleLogin = (name: string, email: string, phone: string, code?: string, type: 'CUSTOMER' | 'PARTNER' | 'REGION' = 'CUSTOMER', avatar?: string) => {
